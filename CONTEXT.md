...
This file is the glossary. Implementation notes live in [`PLAN.md`](./PLAN.md) and [`specs.md`](./specs.md).
...
**Compilation root**
The source file that should be compiled. It contains `\documentclass` and a document body, or the user chose it.
